...
class <%= controller_class_name %>Controller < ApplicationController
  # Be sure to include CMS::Controller::Authentication in Application Controller instead
  ...
  def create
    ...
    # OpenID login begining
      ...
      realm = (url_for :controller => '').gsub('<%= controller_plural_name %>', '')
    ...
    # OpenID login completion
      ...
      when OpenID::Consumer::SUCCESS
        ...
        unless authenticate(:openid, uri)
          ...
          render_component :controller => "<%= model_controller_plural_name %>",
                           :action => "create",
