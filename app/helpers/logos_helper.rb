module LogosHelper
  ...
  #
  #   logo_path(attachment) #=> .../application-pdf.png
  #   logo_path(xhtml_text) #=> .../xhtml_text.png
  #
  # Finally, it looks for the image file in /public/images/models, 
  # and at last in /public_assets/cmsplugin/images/models
  #
  # Options:
  # size:: Size of the logo. Defaults to 16 pixels.
  def logo_path(resource, options = {})
    options[:size] ||= 16
    ...
    if resource.is_a?(Logo)
      ...
      logo_path(resource.logo, options)
    else
