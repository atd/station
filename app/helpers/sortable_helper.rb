  ...
  def sortable_list(object_list, object_class, options = {})
    ...
    returning "" do |html|
      ...
      for object in object_list
        ...
        html << link_to(image_tag("/images/actions/show.png", :alt => "Show".t, :plugin => 'cmsplugin'), polymorphic_path(object))
        html << link_to(image_tag("/images/actions/edit.png", :alt => "Edit".t, :plugin => 'cmsplugin'), edit_polymorphic_path(object))
